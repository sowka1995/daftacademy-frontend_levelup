...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/clock/clockApp.js");
/******/ })
/************************************************************************/
/******/ ({
...
function () {
  _createClass(Clock, [{
    ...
    value:
    /*#__PURE__*/
    regeneratorRuntime.mark(function seconds(initialSecond) {
      var second;
    ...
    value:
    /*#__PURE__*/
    regeneratorRuntime.mark(function minutes(initialMinute) {
      var minute;
    ...
    value:
    /*#__PURE__*/
    regeneratorRuntime.mark(function hours(initialHour) {
      var hour;
  ...
  function Clock() {
    var clockFormat = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 24;
  ...
  _createClass(Clock, [{
    ...
    key: "addOnChange",
    value: function addOnChange(func) {
      this._onChange.push(func);
    }
  }, {
    key: "getClockEventData",
    value: function getClockEventData() {
      return {
    ...
    value: function fireOnChange() {
      var clockEventData = this.getClockEventData();

      for (var i = 0; i < this._onChange.length; i++) {
        var func = this._onChange[i];
    ...
    key: "getHourInClockFormat",
    value: function getHourInClockFormat(hour, clockFormat) {
      if (clockFormat === 12) {
        hour = hour % 12;
        hour = hour === 0 ? 12 : hour;
      }
...
/* harmony import */ var _sass_clock_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sass/clock.scss */ "./src/clock/sass/clock.scss");
/* harmony import */ var _sass_clock_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_sass_clock_scss__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _clock__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./clock */ "./src/clock/clock.js");



var clock24 = new _clock__WEBPACK_IMPORTED_MODULE_2__["default"](24);

var drawClock24 = function drawClock24(clockData) {
...
clock24.start();
var clock12 = new _clock__WEBPACK_IMPORTED_MODULE_2__["default"](12);

var drawClock12 = function drawClock12(clockData) {
